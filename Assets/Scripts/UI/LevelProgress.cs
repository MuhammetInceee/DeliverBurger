...
public class LevelProgress : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        EventManager.OnTotalFoodCountNotify.AddListener(SetHumanCount);
        EventManager.OnFoodThrowed.AddListener(SetShotLeftInfo);
    }
    private void OnDisable()
    {
        ...
        EventManager.OnTotalFoodCountNotify.RemoveListener(SetHumanCount);
        EventManager.OnFoodThrowed.RemoveListener(SetShotLeftInfo);
